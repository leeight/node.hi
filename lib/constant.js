...
exports.ECtFlagConnectStates = {
  ...
  CT_FLAG_KEEPALIVE_2: 47,            // 心跳包, 貌似有37和47两个值
...
exports.ProtocolConstant = {
  ...
  REQUESTER_HEAD_LENGTH: 36           // image request headers size
}
...
exports.ImageType = {
  NULL: 0,                            // null像图
  CHAT_THUMBNAIL: 1,                  // 聊天缩略图
  CHAT_MIDDLE: 2,                     // 聊天中图
  CHAT_LARGE: 3,                      // 聊天大图
  HEAD: 4                             // 头像图片
};

exports.LoginPriority = {
  UNKNOWN: 0,
  FORCE_LOGIN: 0x80000000,
  WEBIM: 10,
  CLIENT: 20
}
...
exports.MAX_CT_BUFFER_SIZE = 64 * 1024;     // 客户端上传图片的时候，最大的chunk限制
exports.MAX_CT_PACKET_SIZE = 64 * 1024;     // 客户端发送的最大包尺寸
exports.MAX_TC_PACKET_SIZE = 256 * 1024;    // 服务器发送的最大包尺寸

// Friend Statuses
exports.CHATER_STATUS_UNAUTH = 0;           // 未验证
exports.CHATER_STATUS_FRIEND = 1;           // 好友
exports.CHATER_STATUS_STRANGER = 2;         // 陌生人
exports.CHATER_STATUS_STOP = 3;             // 已阻止
...
// Image Packet
exports.IMAGE_RESULT_SUCCESS = 0x00000000;    // 交互失败
exports.IMAGE_RESULT_FAIL = 0xFFFFFFFF;       // 交互成功
exports.IMAGE_CHAT = 0;                       // 头像
exports.IMAGE_HEAD = 1;                       // 图片
exports.IMAGE_IS_UP = 1;                      // 上传图片
exports.IMAGE_IS_DOWN = 0;                    // 下载图片
exports.IMAGE_MAX_UPLOAD_SIZE = 1000 * 1024;  // 1000K

// Image Server Request Header Constant
exports.RequestHeader = {
  ...
  MEDIA_AUTH_DATA_RESP: -32767,      // 针对Audio和Vidio的认证的应答
  DISPLAY_IMAGE_AUTH_RESP: -32766,   // 针对头像传输的认证的应答
  EMOTION_IMAGE_AUTH_RESP: -32765,   // 针对表情传输的认证（多人）的应答
  OTHER_IMAGE_AUTH_RESP: -32764,     // 针对普通图片传输的认证（多人）的应答
  FILE_AUTH_RESP: -32763,            // 针对普通文件传输的认证的应答
  ...
  QUERY_DISPLAY_IMAGE_RESP: -32736,
  QUERY_EMOTION_IMAGE_RESP: -32735,
  QUERY_OTHER_IMAGE_RESP: -32734,

  UPLOAD_DISPLAY_IMAGE_RESP: -32733,
  UPLOAD_EMOTION_IMAGE_RESP: -32732,
  UPLOAD_OTHER_IMAGE_RESP: -32731,

  DOWNLOAD_DISPLAY_IMAGE_RESP: -32730,
  DOWNLOAD_EMOTION_IMAGE_RESP: -32729,
  DOWNLOAD_OTHER_IMAGE_RESP: -32728
};
